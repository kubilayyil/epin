<?php
 ...
 if ($kbilgi["yetki"]>0) { 
 }  else if($kbilgi["yetki"]==0){ header("Location:logout.php"); } } elseif(!isset($_SESSION["mail"])){header("Location:giris-yap");} 
...
<link type="text/css" rel="stylesheet" href="<? echo $sites["site_link"];?>/epin/all.css" />
  <script src="<? echo $sites["site_link"];?>/epin/sweetalert2@9"></script>
</head>